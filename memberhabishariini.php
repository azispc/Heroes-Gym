...
$result = mysqli_query($mysqli, "SELECT * FROM pelanggan, member WHERE pelanggan.id_pel = member.id_pelanggan AND member.ends='$waktusekarang' ORDER BY pelanggan.id_pel ASC"); // using mysqli_query instead
?>

<html>
<head>
	<title>Member Habis</title>
</head>
...
<body>
	...
	<?php
  echo "<center>";
  echo "<h2> DAFTAR MEMBER HABIS HARI INI HEROES GYM</h2>";
