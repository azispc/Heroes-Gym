...
$result = mysqli_query($mysqli, "SELECT * FROM pelanggan, member WHERE pelanggan.id_pel = member.id_pelanggan AND member.start='$waktusekarang' ORDER BY pelanggan.id_pel ASC"); // using mysqli_query instead
?>

<html>
<head>
	<title>Member Hari ini</title>
</head>
...
<body>
	...
	<?php
	echo "<center>";
	echo "<h2> DAFTAR MEMBER BARU HARI INI HEROES GYM</h2>";
